...
| **[Leverage AI](https://github.com/eddie7ch/leverage-ai-architecture)** — AI missed-call recovery *(live product, real clients)* | Twilio + Claude tool-use + Google Calendar. The AI is constrained to three forced-tool outcomes (ask / escalate / book) — it never freelances a price or a promised arrival time. Running in production for home-service businesses today. |
...
| **[SocietyCheck](https://github.com/eddie7ch/SocietyCheck-showcase)** | End-to-end short-form video pipeline — script, TTS voiceover, footage assembly, and per-platform publishing to YouTube/Facebook/Instagram/TikTok, fully automated. |
