...
| **[Algorithm Visualizer](https://github.com/eddie7ch/algo-visualizer)**: sorting & pathfinding, from scratch | Six sorts, four pathfinding algorithms (BFS/DFS/Dijkstra/A*), every one implemented as a generator function with no library shortcuts. It's the classical-CS-fundamentals counterpart to the systems work above. |
